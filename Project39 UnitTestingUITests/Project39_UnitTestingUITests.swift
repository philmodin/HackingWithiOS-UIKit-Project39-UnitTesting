//
//  Project39_UnitTestingUITests.swift
//  Project39 UnitTestingUITests
//
...
class Project39_UnitTestingUITests: XCTestCase {
    ...
    func testInitialStateIsCorrect() {
        ...
        XCTAssertEqual(table.cells.count, 7, "There should 7 rows initially")
    }
    
    func testUserFilterByString() {
        let app = XCUIApplication()
        app.launch()
